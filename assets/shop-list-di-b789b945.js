import{a,b as e,c,N as n}from"./header-mobile-menu-a9ce0c7f.js";const r=new n;let h=localStorage.getItem("shopping-list");const p=JSON.parse(h),d=document.querySelector(".shop-list"),g=document.querySelector(".shop-div"),m=async l=>{for(const s of l){const i=await r.fetchBooksForId(s);Array.isArray(i)?i.forEach(t=>{o(t)}):o(i)}function o(s){console.log(s),g.innerHTML="";const i=`
