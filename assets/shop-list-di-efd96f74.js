import{a as e,b as a,c as n,N as c}from"./header-mobile-menu-7a809013.js";const r=new c;let h=localStorage.getItem("shopping-list");const p=JSON.parse(h),d=document.querySelector(".shop-list"),m=document.querySelector(".shop-background"),k=async t=>{for(const s of t){const o=await r.fetchBooksForId(s);Array.isArray(o)?o.forEach(l=>{i(l)}):i(o)}function i(s){m.innerHTML="";const o=`
