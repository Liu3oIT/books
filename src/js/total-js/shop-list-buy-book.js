      ...
      <div class="sh-wrap">
        ...
        <div class="sh-book-info-link-wrap">
          ...
          <ul class="shopping-links">
            <li class="sh-soc-item"><a href="${book.buy_links[0].url}" class="amazon-link" target="_blank"><img class="store-link-img amazon-store" src="${amazon}" alt=""></a></li>
            <li class="sh-soc-item"><a href="${book.buy_links[1].url}" class="app-book-link" target="_blank"><img class="store-link-img apple-store" src="${applebook}" alt=""></a></li>
            <li class="sh-soc-item"><a href="${book.buy_links[3].url}" class="book-shop-link" target="_blank"><img class="store-link-img book-shop" src="${bookshop}" alt=""></a></li>
          </ul>
        </div>
      </div>
